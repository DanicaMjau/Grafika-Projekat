...
public class ImageViewer extends JPanel implements MouseMotionListener, MouseListener, MouseWheelListener, ComponentListener, KeyListener {
	...
	public static JInternalFrame constructViewer(BufferedImage imageA, BufferedImage imageB, String title)
	{
		if(title == null) title = "Image viewer";
		
		JInternalFrame window = new JInternalFrame(title);
	...
	public static JInternalFrame showImageWindow(BufferedImage image, String title)
	{
		JInternalFrame win = constructViewer(image, null, title);
		win.setSize(500, 500);
